...
% \toprule
% Dataset & Model & Params & $L$ & $d_{\text{model}}$ & $n_h^{sa}$ & $n_h^{ra}$ &  Accuracy \\
% \midrule
...
\begin{tabular}{l|l|c|c}
    ...
    \midrule
    \multirow{2}{*}{CIFAR-10} & \textit{ViT} & 7.1M & $86.4 \pm 0.1\%$ \\
              & \textit{ViDAT} & 6.0M & $\mathbf{89.7 \pm 0.1\%}$ \\
    \hline
    \multirow{2}{*}{CIFAR-100} & \textit{ViT} & 7.2M & $68.8 \pm 0.2\%$ \\
              & \textit{ViDAT} & 6.1M & $\mathbf{70.5 \pm 0.1\%}$ \\
    \bottomrule
\end{tabular}
