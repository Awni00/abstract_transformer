...
However, confirming this hypothesis requires empirical validation (which we currently do not have the resources to do at our academic institution). As you rightly mentioned, and as discussed above, scaling further introduces new challenges and the availability of various optimization tricks becomes an important consideration.
