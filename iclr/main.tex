...
\newcommand{\edit}[1]{\textcolor{Bittersweet}{#1}}
\newcommand{\trim}[1]{\textcolor{VioletRed}{#1}}
\newcommand{\todo}[1]{\textcolor{PineGreen}{#1}}
...
\aafatal{remove acknowledgements and adjust reproducibility statepment}
