...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
                 kdim=None, vdim=None, outdim=None, batch_first=False, device=None, dtype=None) -> None:
        ...
        self.out_proj = NonDynamicallyQuantizableLinear(embed_dim, self.outdim, bias=bias, **factory_kwargs)
