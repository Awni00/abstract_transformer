...
\title{A generalized Transformer architecture that captures both relational and sensory information}
...
\input{abstract_attention.tex}

\input{attention_inductive_biases.tex}
