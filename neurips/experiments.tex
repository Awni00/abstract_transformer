...
\aawarning{TODO -- is Transformer+ discracting? should it be removed or moved to the appendix? it does not make a noticeable difference and reviewers may ask why we don't also do this for the other experiments.}
...
In the final set of experiments, we evaluate Orthrus on a vision task---object classification with the ImageNet dataset~\citep{imagenet}. This further probes Orthrus' ability in different modalities as a general-purpose sequence model. This section also stress tests Orthrus at large scales.
...
\aawarning{TODO--update this figure once continuation of training of Orthrus is completed...}
