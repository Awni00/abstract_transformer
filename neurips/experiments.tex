...
\begin{figure}[t]
    \begin{subfigure}[t]{\textwidth}
        \scalebox{-1}[-1]{\includegraphics[height=\textwidth, angle=-90]{figs/experiments/fineweb/viz/DAT-343M-viz-L1-rel1-model.png}}
        % \caption{}\label{fig:}
    \end{subfigure}
    \begin{subfigure}[t]{\textwidth}
        \scalebox{-1}[-1]{\includegraphics[height=\textwidth, angle=-90]{figs/experiments/fineweb/viz/DAT-343M-viz-L12-rel2-state.png}}
        % \caption{}\label{fig:}
    \end{subfigure}
