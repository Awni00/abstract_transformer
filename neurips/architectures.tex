\section{Orphrus: The Dual-Head Transformer Architecture}
...
We nickname models with this ``dual head-type'' architecture \aanote*{any other options for 2-headed mythological creatures? Orphrus may be slightly hard to pronounce? (for silly people like me)}{Orphrus}, after the two-headed dog in greek mythology. We note that a standard Transformer is a special case of this architecture where $n_h^{sa} = n_h, n_h^{ra} = 0$.
