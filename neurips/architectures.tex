...
\begin{remark}
    ...
    The rationale is that, since the role of symbols is merely to act as \aanote*{word choice... stick to ``codes'' or use ``identifier'' or ``pointer''}{abstract codes}, they can be remapped at each layer (e.g., a variable can be reassigned to point to a different object).
...
\end{remark}
\aanote{keep or remove this remark? perhaps trim? keep as remark or integrate into main text?}
...
\aanote{removed Orthos name. TODO---make sure this is done consistently throughout}
