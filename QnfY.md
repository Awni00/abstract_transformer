...
*Additional relational games baselines.* We have added several relational architecture baselines (PrediNet, CoRelNet, Abstractor) to the relational games experiments. We refer to Figure 1 in the attached 1-page pdf. We find that *DAT* performs competitively with the relational architectures, all of which outperform the Transformer. 
